...
@section('meta')
    <title>Berita | {{ $company_data[0]['name'] }}</title>
    ...
    <meta property="og:title" content="Berita | {{ $company_data[0]['name'] }}" />
    ...
    <meta property="og:url" content="{{ route('blog.show') }}"/>
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="{{ str_limit($company_data[0]['meta_description'], 200) }}" />
    <meta name="twitter:title" content="Berita | {{ $company_data[0]['name'] }}" />
                                ...
                                @foreach($blogs as $blog)
                                    <article class="list">
                                        <div class="wrapper-list">
                                            <div class="thumb">
                                                <a href="{{ route('blog.id', ['id' => strtolower($blog['slug'])]) }}">
                                                    <img src="{{ $blog['image'] }}">
                                                </a>
                                            </div>
                                            <div class="desc">
                                                <div class="content">
                                                    ...
                                                    <p class="more">
                                                        <a href="{{ route('blog.id', ['id' => strtolower($blog['slug'])]) }}">selengkapnya ...</a>
                                                    </p>

                                                    <div class="time-comment">
                                                        <span>
                                                            <i class="fa fa-calendar-o" aria-hidden="true"></i> {{$blog['created_at']->format('F d, Y')}}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
