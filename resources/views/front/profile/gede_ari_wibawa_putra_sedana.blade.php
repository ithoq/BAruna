...
@section('meta')
    <title>Profil Gede Ari Wibawa Putra Sedana | {{ $company_data[0]['name'] }}</title>
    ...
    <section class="breadcumb">
        <div class="container-fluid">
            <ul>
                ...
                <li><a href="{{ route('profile.id', 'gede-ari-wibawa-putra-sedana') }}">Gede Ari Wibawa Putra Sedana</a></li>
            </ul>
        </div>
    </section>
    <section class="title">
        <div class="container-fluid">
            <h2>Profil <span>Gede Ari Wibawa Putra Sedana</span></h2>
        </div>
    </section>
            ...
            <div class="row">
                <div class="p-detail">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="#">
                        <img src="http://demo.bpraruna.com/img/Direksi-3.jpg" alt="image profile" class="l-profile-image">
                      </a>
                    </div>
                    <div class="col-lg-6">
                      <h5 style="margin-top: 0px;color:#4ea0ff;font-size: 2.25rem;font-family: 'Roboto', sans-serif;">Direktur Kepatuhan<br><small style="color:#4ea0ff;font-size: 80%;font-weight: 400;">Menjabat sebagai Direktur Kepatuhan.<br>Sejak tanggal 19 Maret 2018.</small></h5>
                      <!--<p style="font-family: 'Roboto', sans-serif;">Gelar Sarjana Peternakan dari Fakultas Peternakan, Universitas Brawijaya. Malang.</p>-->
                  ...
                  <div class="row">
                    <div class="about-us col-lg-12">
                      ...
                      <p>Lahir di Denpasar, Bali pada tanggal 25 Oktober 1969. Beliau memperoleh gelar Sarjana Peternakan dari Fakultas Peternakan, Universitas Brawijaya, Malang.
                        Beliau menjabat sebagai Direktur Kepatuhan PT. BPR Aruna Nirmaladuta sejak tanggal 19 Maret 2018.
                        Beliau memiliki pengalaman selama lebih dari 17 tahun dalam industri perbankan. Karier beliau dimulai sebagai Branch Operation Supervisor di Bank Bali pada tahun 1995. Selanjutnya, Beliau pernah bekerja di Bank Permata sebagai Human Resources Relationship Manager, bekerja di PT. BPR Legian sebagai Human Resources & Service Quality Manager dan terakhir bekerja di Bank Andara sebagai Human Resources Division Head.
                      </p>
                    </div>
                  </div>
                </div>
