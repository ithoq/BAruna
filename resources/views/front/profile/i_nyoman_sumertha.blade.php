...
@section('meta')
    <title>Profil I Nyoman Sumertha | {{ $company_data[0]['name'] }}</title>
    ...
    <section class="breadcumb">
        <div class="container-fluid">
            <ul>
                ...
                <li><a href="{{ route('profile.id', 'i-nyoman-sumertha') }}">Profil I Nyoman Sumertha</a></li>
            </ul>
        </div>
    </section>
    <section class="title">
            ...
            <div class="row">
                <div class="p-detail">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="#">
                        <img src="http://demo.bpraruna.com/img/komisaris-1.jpg" alt="image profile" class="l-profile-image">
                      </a>
                    </div>
                    <div class="col-lg-6">
                      <h5 style="margin-top: 0px;color:#4ea0ff;font-size: 2.25rem;font-family: 'Roboto', sans-serif;">Komisaris Utama<br><small style="color:#4ea0ff;font-size: 80%;font-weight: 400;">Menjabat sebagai Komisaris Utama.<br>Sejak tanggal 19 Maret 2018.</small></h5>
                      <!--<p style="font-family: 'Roboto', sans-serif;">Gelar Sarjana Ekonomi dari jurusan Ekonomi Manajemen, Fakultas Ekonomi, Universitas Mahasaraswati, Denpasar.</p>-->
                  ...
                  <div class="row">
                    <div class="about-us col-lg-12">
                      ...
                      <p>Lahir di Denpasar, Bali pada tanggal 29 April 1969. Beliau memperoleh gelar Sarjana Ekonomi dari jurusan Ekonomi Manajemen, Fakultas Ekonomi, Universitas Mahasaraswati, Denpasar.
                        Beliau menjabat sebagai Komisaris Utama PT. BPR Aruna Nirmaladuta sejak tanggal 19 Maret 2018. Beliau memiliki pengalaman selama lebih dari 24 tahun dalam industri perbankan. Karier beliau dimulai sebagai tenaga EDP/IT di Bank Dagang Bali pada tahun 1989. Selanjutnya, beliau pernah bekerja di  Bank Harapan Sentosa sebagai tenaga Accounting dan IT serta terakhir bekerja di Rabobank sebagai Credit Middle Officer.
                      </p>
                    </div>
                  </div>
                </div>
