...
@section('meta')
    <title>Profil A. A. Raka Erna Dwajayanti | {{ $company_data[0]['name'] }}</title>
    ...
    <section class="breadcumb">
        <div class="container-fluid">
            <ul>
                ...
                <li><a href="{{ route('profile.id', 'raka-erna-dwajayanti') }}">Profil A. A. Raka Erna Dwajayanti</a></li>
            </ul>
        </div>
    </section>
    <section class="title">
        <div class="container-fluid">
            <h2>Profil <span>A. A. Raka Erna Dwajayanti</span></h2>
        </div>
    </section>
            ...
            <div class="row">
                <div class="p-detail">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="#">
                        <img src="http://demo.bpraruna.com/img/Direksi-1.jpg" alt="image profile" class="l-profile-image">
                      </a>
                    </div>
                    <div class="col-lg-6">
                      <h5 style="margin-top: 0px;color:#4ea0ff;font-size: 2.25rem;font-family: 'Roboto', sans-serif;">Direktur Bisnis<br><small style="color:#4ea0ff;font-size: 80%;font-weight: 400;">Menjabat sebagai Direktur Bisnis.<br>Sejak tanggal 19 Maret 2018.</small></h5>
                      <!--<p style="font-family: 'Roboto', sans-serif;">Gelar Sarjana Ekonomi dari jurusan Akuntasi, Fakultas Ekonomi, Universitas Warmadewa, Denpasar.</p>-->
                  ...
                  <div class="row">
                    <div class="about-us col-lg-12">
                      ...
                      <p>Lahir di Gianyar, Bali pada tanggal 23 Nopember 1977. Beliau memperoleh gelar Sarjana Ekonomi dari jurusan Akuntasi, Fakultas Ekonomi, Universitas Warmadewa, Denpasar.
                        Beliau menjabat sebagai Direktur Bisnis PT. BPR Aruna Nirmaladuta sejak tanggal 19 Maret 2018. Beliau memiliki pengalaman selama lebih dari 16 tahun dalam industri perbankan dan pembiayaan keuangan. Karier beliau dimulai sebagai Relationship Officer di Lippo Bank pada tahun 2001. Selanjutnya, beliau pernah bekerja di Bank Mega sebagai Account Officer, bekerja di Permodalan Nasional Madani (PNM) sebagai Manager Unit, Asisten Manager Cluster, Manajer Cluster, Kepala Pembinaan dan terakhir bekerja di PT. BPR Aruna Nirmaladuta sebagai Kepala Bagian Bisnis.
                      </p>
                    </div>
                  </div>
                </div>
