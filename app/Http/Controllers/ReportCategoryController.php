...
class ReportCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('size')){
                ...
                return response()->json(ReportCategory::where('company_id','=',$company_id)
        ...
        return response()->json(ReportCategory::where('company_id','=',$company_id)->get(), 200, [], JSON_NUMERIC_CHECK);
    }
    ...
    public function store(Request $request)
    {
        ...
        $row=ReportCategory::where('name','=',$request->json('name'))
    ...
    {
        return response()->json(ReportCategory::find($id), 200, [], JSON_NUMERIC_CHECK);
    }
