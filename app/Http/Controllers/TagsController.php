...
class TagsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('size')){
                ...
                return response()->json(Tags::where('company_id','=',$company_id)
        ...
        return response()->json(Tags::where('company_id','=',$company_id)->get(), 200, [], JSON_NUMERIC_CHECK);
    }
    ...
    public function store(Request $request)
    {
        ...
        $row=Tags::where('name','=',$request->json('name'))
        ...
        $obj->save();
        $this->makeLog($request,$company,$obj->created_by,'Tags was created');
        return response()->json(array(
                            'error' => false,
    ...
    {
        return response()->json(Tags::find($id), 200, [], JSON_NUMERIC_CHECK);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $obj->save();
        $this->makeLog($request,$company,$obj->updated_by,'Tags was Updated');
        return response()->json(array(
                                        'error' => false,
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $obj->update();
        if ($obj->delete()) {
            $this->makeLog($request,$company,JWTAuth::parseToken()->toUser()->username,'Tags was deleted');
