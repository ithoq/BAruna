...
class SliderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json(Slider::where('company_id','=',$company_id)->get(),200, [], JSON_NUMERIC_CHECK);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $image=AppHelper::upload_image($request,Uuid::generate(),$company->code,false);
          if ($image['error']==true){
            ...
            $obj->save();  
             ...
             $slider=Slider::find($id->__toString());
